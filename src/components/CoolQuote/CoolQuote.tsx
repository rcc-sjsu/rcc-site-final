  ...
  return (
    <section className={styles.container} aria-label="Quote from RCC founder">
      ...
      <figure className={styles.quote}>
        <blockquote>
          <p>
            Our goal isn&rsquo;t just to study technology, but to question it, to understand its effects, and to make sure
            it&rsquo;s applied <em><b>responsibly</b></em>.
          </p>
        </blockquote>
