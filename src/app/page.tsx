  ...
  return (
    <div style={{ overflow: 'clip' }}>
      ...
      <section className={aboutStyles.container}>
        ...
        <BackgroundGradient className={aboutStyles.gradient1} color="purple" />
        ...
        {/* Data Analytics */}
        <ul className="flex flex-col md:grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 auto-cols-max gap-9 md:gap-10 xl:gap-5 place-items-center justify-between w-full md:w-[75%] xl:w-full h-auto md:h-full lg:h-auto mt-10 text-brand-indigo">
          <li className="h-auto md:h-full lg:h-auto flex flex-col justify-center border-2 md:border-4 border-brand-indigo bg-[#F2E4FE] rounded-2xl px-10 lg:px-7 xl:px-10 py-3 shadow-[5px_5px_0_var(--color-brand-indigo)] md:shadow-[7px_7px_0_var(--color-brand-indigo)]">
      ...
      <section className={industryStyles.container}>
        ...
        <div className="flex flex-col h-full justify-items-center items-stretch md:grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 auto-cols-max gap-2 md:gap-7 xl:gap-4">
          {/* NEED TO ADD A BACKGROUND COLOR OF WHITE TO EACH OF THE FIGURES ONES THE REBRAND COLORS HAVE BEEN CHOSEN */}
      ...
      <section className={socialMediaStyles.container}>
        ...
        <div className="flex flex-col md:grid md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 auto-cols-max gap-4 md:gap-7 xl:gap-4 lg:w-full">
            <Link
              href="https://www.instagram.com/rcc.sjsu/"
              target="_blank"
            className="flex justify-center px-5 py-3 md:px-7 md:py-4 bg-brand-lavender text-brand-indigo rounded-lg border-2 border-brand-indigo hover:bg-brand-indigo hover:**:p-0 hover:text-white focus:outline-3 focus:outline-offset-4  focus:outline-brand-light-steel-blue focus:bg-brand-indigo focus:**:p-0 focus:text-white focus:font-semibold active:outline-offset-4 active:bg-brand-indigo active:**:p-0 active:text-white active:font-semibold"
          >
          ...
          <Link
            ...
            target="_blank"
            className="flex justify-center px-5 py-3 md:px-4 lg:px-7 xl:px-4 md:py-4 lg:py-3 xl:py-4 bg-brand-lavender text-brand-indigo rounded-lg border-2 border-brand-indigo hover:bg-brand-indigo hover:**:p-0 hover:text-white focus:outline-3 focus:outline-offset-4  focus:outline-brand-light-steel-blue focus:bg-brand-indigo focus:**:p-0 focus:text-white focus:font-semibold active:outline-offset-4 active:bg-brand-indigo active:**:p-0 active:text-white active:font-semibold"
          >
            <div className="flex gap-2 md:gap-4 place-items-center justify-start lg:justify-center">
              <SiDiscord
                role="presentation"
              ...
              <div className="text-left">
                ...
                <p className="text-lg md:text-xl">Discord</p>
              </div>
            </div>
          </Link>
            <Link
              ...
              target="_blank"
            className="flex justify-items-center py-3 px-8 md:py-4 bg-brand-lavender text-brand-indigo rounded-lg border-2 border-brand-indigo hover:bg-brand-indigo hover:**:p-0 hover:text-white focus:outline-3 focus:outline-offset-4  focus:outline-brand-light-steel-blue focus:bg-brand-indigo focus:**:p-0 focus:text-white focus:font-semibold active:outline-offset-4 active:bg-brand-indigo active:**:p-0 active:text-white active:font-semibold"
          >
            <div className="flex gap-2 md:gap-5 lg:gap-4 place-items-center justify-start lg:justify-center">
             ...
             <Link
              ...
              target="_blank"
            className="flex justify-items-center px-8 py-3 md:py-4 bg-brand-lavender text-brand-indigo rounded-lg border-2 border-brand-indigo hover:bg-brand-indigo hover:**:p-0 hover:text-white focus:outline-3 focus:outline-offset-4  focus:outline-brand-light-steel-blue focus:bg-brand-indigo focus:**:p-0 focus:text-white focus:font-semibold active:outline-offset-4 active:bg-brand-indigo active:**:p-0 active:text-white active:font-semibold"
          >
            <div className="flex gap-2 md:gap-4 place-items-center justify-start lg:justify-center">
              <CiMail
                role="presentation"
